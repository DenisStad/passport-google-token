...
GoogleTokenStrategy.prototype.authenticate = function(req, options) {
  ...
  var accessToken = req.body.id_token || req.query.id_token || req.headers.id_token;
...
GoogleTokenStrategy.prototype.userProfile = function(accessToken, done) {
  this._oauth2.get('https://www.googleapis.com/oauth2/v3/tokeninfo', accessToken, function (err, body, res) {
